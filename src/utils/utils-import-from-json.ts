      ...
      triggers: [
        {
          ...
          timeevent: 'AFTER UPDATE',
          logic:
            'WHEN NEW.recordType = 3 BEGIN UPDATE images SET recordType = 3 WHERE ticketId=OLD.id; END;',
        },
      ],
    },
    {
      ...
      schema: [
        ...
        {
          foreignkey: 'ticketId',
          value: 'REFERENCES tickets(id) ON DELETE CASCADE',
        },
      ],
      indexes: [
  ...
  tables: [
    {
      ...
      schema: [
        ...
        {
          constraint: 'PK_albumartist_albumname',
          value: 'PRIMARY KEY (albumartist,albumname)',
        },
      ],
      indexes: [
        {
          name: 'index_album_on_albumartist_albumname',
          value: 'albumartist,albumname',
        },
    ...
    },
    {
      ...
      indexes: [
        {
          name: 'index_song_on_songartist_songalbum',
          value: 'songartist,songalbum',
        },
        {
...
export const fullImport192 = {
  ...
  tables: [
    ...
    },
    {
      ...
      indexes: [{ name: 'route_points_id_uindex', value: 'id' }],
    },
  ],
};
